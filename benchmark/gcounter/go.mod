...
replace counter => ../../test/files/general/gcounter.tla.gotests
...
require (
	github.com/UBC-NSS/pgo/distsys v0.0.0-20211212010158-b0554058d731 // indirect
