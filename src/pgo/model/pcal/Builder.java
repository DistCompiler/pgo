...
public class Builder {
	...
	public static Algorithm algorithm(String name, List<VariableDecl> vars, List<Macro> macros, List<Procedure> procedures, List<PGoTLAUnit> units, LabeledStatements... statements) {
		return new Algorithm(SourceLocation.unknown(), name, vars, macros, procedures, units, new SingleProcess(SourceLocation.unknown(), Arrays.asList(statements)));
	}
	
	public static Algorithm algorithm(String name, List<VariableDecl> vars, List<Macro> macros, List<Procedure> procedures, List<PGoTLAUnit> units, PcalProcess... processes) {
		return new Algorithm(SourceLocation.unknown(), name, vars, macros, procedures, units, new MultiProcess(SourceLocation.unknown(), Arrays.asList(processes)));
	}
