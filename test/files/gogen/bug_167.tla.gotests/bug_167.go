...
func NUM_NODES(iface distsys.ArchetypeInterface) tla.Value {
	return tla.Symbol_PlusSymbol(tla.Symbol_PlusSymbol(iface.GetConstant("NUM_REPLICAS")(), iface.GetConstant("NUM_PUT_CLIENTS")()), iface.GetConstant("NUM_GET_CLIENTS")())
}
...
func PUT_CLIENT_SET(iface distsys.ArchetypeInterface) tla.Value {
	return tla.Symbol_DotDotSymbol(tla.Symbol_PlusSymbol(iface.GetConstant("NUM_REPLICAS")(), tla.MakeNumber(1)), tla.Symbol_PlusSymbol(iface.GetConstant("NUM_REPLICAS")(), iface.GetConstant("NUM_PUT_CLIENTS")()))
}
func GET_CLIENT_SET(iface distsys.ArchetypeInterface) tla.Value {
	return tla.Symbol_DotDotSymbol(tla.Symbol_PlusSymbol(tla.Symbol_PlusSymbol(iface.GetConstant("NUM_REPLICAS")(), iface.GetConstant("NUM_PUT_CLIENTS")()), tla.MakeNumber(1)), tla.Symbol_PlusSymbol(tla.Symbol_PlusSymbol(iface.GetConstant("NUM_REPLICAS")(), iface.GetConstant("NUM_PUT_CLIENTS")()), iface.GetConstant("NUM_GET_CLIENTS")()))
}
...
var jumpTable = distsys.MakeMPCalJumpTable(
	...
	distsys.MPCalCriticalSection{
		...
		Body: func(iface distsys.ArchetypeInterface) error {
			...
			if tla.MakeBool(tla.Symbol_EqualsSymbol(condition, iface.Self()).AsBool() && condition0.AsBool()).AsBool() {
				err = iface.Write(shouldSync, nil, tla.Symbol_TRUE)
				if err != nil {
					return err
				}
		...
		Body: func(iface distsys.ArchetypeInterface) error {
			...
			if tla.Symbol_EqualsSymbol(condition25.ApplyFunction(tla.MakeString("typ")), GET_REQ(iface)).AsBool() {
				...
				if tla.Symbol_EqualsSymbol(condition26.ApplyFunction(tla.MakeString("typ")), PUT_REQ(iface)).AsBool() {
					...
					if !tla.Symbol_GreaterThanSymbol(condition27.ApplyFunction(tla.MakeString("body")).ApplyFunction(tla.MakeString("versionNumber")), condition28.ApplyFunction(tla.MakeString("versionNumber"))).AsBool() {
	...
	distsys.MPCalCriticalSection{
		...
		Body: func(iface distsys.ArchetypeInterface) error {
			...
			case 0:
				...
				if !tla.MakeBool(tla.MakeBool(tla.MakeBool(tla.MakeBool(tla.MakeBool(tla.Symbol_EqualsSymbol(condition58.ApplyFunction(tla.MakeString("to")), iface.Self()).AsBool() && tla.Symbol_EqualsSymbol(condition59.ApplyFunction(tla.MakeString("from")), condition60).AsBool()).AsBool() && tla.Symbol_EqualsSymbol(condition61.ApplyFunction(tla.MakeString("body")), ACK_MSG_BODY(iface)).AsBool()).AsBool() && tla.Symbol_EqualsSymbol(condition62.ApplyFunction(tla.MakeString("srcTyp")), PRIMARY_SRC(iface)).AsBool()).AsBool() && tla.Symbol_EqualsSymbol(condition63.ApplyFunction(tla.MakeString("typ")), PUT_RESP(iface)).AsBool()).AsBool() && tla.Symbol_EqualsSymbol(condition64.ApplyFunction(tla.MakeString("id")), tla.MakeNumber(1)).AsBool()).AsBool() {
			...
			case 1:
				...
				if !tla.MakeBool(condition66.AsBool() && tla.Symbol_EqualsSymbol(condition67, tla.MakeNumber(0)).AsBool()).AsBool() {
					return distsys.ErrCriticalSectionAborted
				}
				return iface.Goto("APutClient.sndPutReq")
			default:
	...
	distsys.MPCalCriticalSection{
		...
		Body: func(iface distsys.ArchetypeInterface) error {
			...
			if tla.Symbol_NotEqualsSymbol(condition68, NULL(iface)).AsBool() {
	...
	distsys.MPCalCriticalSection{
		...
		Body: func(iface distsys.ArchetypeInterface) error {
			...
			case 0:
				...
				if !tla.MakeBool(tla.MakeBool(tla.MakeBool(tla.MakeBool(tla.Symbol_EqualsSymbol(condition71.ApplyFunction(tla.MakeString("to")), iface.Self()).AsBool() && tla.Symbol_EqualsSymbol(condition72.ApplyFunction(tla.MakeString("from")), condition73).AsBool()).AsBool() && tla.Symbol_EqualsSymbol(condition74.ApplyFunction(tla.MakeString("srcTyp")), PRIMARY_SRC(iface)).AsBool()).AsBool() && tla.Symbol_EqualsSymbol(condition75.ApplyFunction(tla.MakeString("typ")), GET_RESP(iface)).AsBool()).AsBool() && tla.Symbol_EqualsSymbol(condition76.ApplyFunction(tla.MakeString("id")), tla.MakeNumber(2)).AsBool()).AsBool() {
