...
VARIABLES todo, sols, rVal, pc, stack, queens, i, j

vars == << todo, sols, rVal, pc, stack, queens, i, j >>

Init == (* Global variables *)
        /\ todo = { << >> }
        /\ sols = {}
        /\ rVal = defaultInitValue
        (* Procedure PgoAttacks *)
        /\ queens = defaultInitValue
        /\ i = defaultInitValue
        /\ j = defaultInitValue
        /\ stack = << >>
        /\ pc = "nxtQ"
...
attlabl == /\ pc = "attlabl"
           /\ rVal' = (         \/ queens[i] = queens[j]
                       \/ queens[i] - queens[j] = i - j
                       \/ queens[j] - queens[i] = i - j)
           /\ pc' = Head(stack).pc
           /\ queens' = Head(stack).queens
           /\ i' = Head(stack).i
           /\ j' = Head(stack).j
           /\ stack' = Tail(stack)
           /\ UNCHANGED << todo, sols >>
...
nxtQ == /\ pc = "nxtQ"
        /\ IF todo # {}
              ...
              ELSE /\ pc' = "Done"
                   /\ UNCHANGED << todo, sols >>
        /\ UNCHANGED << rVal, stack, queens, i, j >>

Next == PgoAttacks \/ nxtQ
...
\* Last modified Wed Mar 08 15:46:36 PST 2017 by algae
