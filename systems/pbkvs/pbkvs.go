...
func CLIENT_SET(iface distsys.ArchetypeInterface) tla.TLAValue {
	return tla.TLA_DotDotSymbol(tla.TLA_PlusSymbol(iface.GetConstant("NUM_REPLICAS")(), tla.MakeTLANumber(1)), tla.TLA_PlusSymbol(iface.GetConstant("NUM_REPLICAS")(), iface.GetConstant("NUM_CLIENTS")()))
}
...
var jumpTable = distsys.MakeMPCalJumpTable(
		...
		Body: func(iface distsys.ArchetypeInterface) error {
			...
			if tla.MakeTLABool(tla.TLA_EqualsSymbol(condition19, iface.Self()).AsBool() && condition20.AsBool()).AsBool() {
				...
				if iface.GetConstant("DEBUG")().AsBool() {
					...
					tla.MakeTLATuple(tla.MakeTLAString("ServerRcvReq"), iface.Self(), toPrint).PCalPrint()
					// no statements
				} else {
					// no statements
				}
	...
	distsys.MPCalCriticalSection{
		...
		Body: func(iface distsys.ArchetypeInterface) error {
			...
			if iface.GetConstant("DEBUG")().AsBool() {
				tla.MakeTLATuple(tla.MakeTLAString("ServerHandleBackup"), iface.Self()).PCalPrint()
				// no statements
			} else {
				// no statements
			}
			var condition24 tla.TLAValue
			condition24, err = iface.Read(req3, []tla.TLAValue{})
			if err != nil {
				return err
			}
			...
			if tla.TLA_EqualsSymbol(condition25.ApplyFunction(tla.MakeTLAString("typ")), GET_REQ(iface)).AsBool() {
				...
				if tla.TLA_EqualsSymbol(condition26.ApplyFunction(tla.MakeTLAString("typ")), PUT_REQ(iface)).AsBool() {
					...
					condition27, err = iface.Read(req3, []tla.TLAValue{})
					if err != nil {
						return err
					}
					...
					exprRead15, err = iface.Read(req3, []tla.TLAValue{})
					if err != nil {
						return err
					}
					...
					condition29, err = iface.Read(req3, []tla.TLAValue{})
					if err != nil {
						return err
					}
					if tla.TLA_EqualsSymbol(condition29.ApplyFunction(tla.MakeTLAString("typ")), SYNC_REQ(iface)).AsBool() {
						...
						condition30, err = iface.Read(req3, []tla.TLAValue{})
						if err != nil {
							return err
						}
						...
						if tla.TLA_GreaterThanSymbol(condition30.ApplyFunction(tla.MakeTLAString("body")).ApplyFunction(tla.MakeTLAString("versionNumber")), condition31.ApplyFunction(tla.MakeTLAString("versionNumber"))).AsBool() {
							...
							exprRead16, err = iface.Read(req3, []tla.TLAValue{})
							if err != nil {
								return err
							}
							var indexRead2 tla.TLAValue
							indexRead2, err = iface.Read(req3, []tla.TLAValue{})
							if err != nil {
								return err
							}
							...
							exprRead17, err = iface.Read(req3, []tla.TLAValue{})
							if err != nil {
								return err
							}
			...
			exprRead19, err = iface.Read(req3, []tla.TLAValue{})
			if err != nil {
				return err
			}
			...
			exprRead22, err = iface.Read(req3, []tla.TLAValue{})
			if err != nil {
				return err
			}
	...
	distsys.MPCalCriticalSection{
		...
		Body: func(iface distsys.ArchetypeInterface) error {
			...
			if iface.GetConstant("DEBUG")().AsBool() {
				tla.MakeTLATuple(tla.MakeTLAString("ServerHandlePrimary"), iface.Self()).PCalPrint()
				// no statements
			} else {
				// no statements
			}
			var condition34 tla.TLAValue
			condition34, err = iface.Read(req18, []tla.TLAValue{})
			if err != nil {
				return err
			}
			...
			if tla.TLA_EqualsSymbol(condition35.ApplyFunction(tla.MakeTLAString("typ")), GET_REQ(iface)).AsBool() {
				...
				if tla.TLA_EqualsSymbol(condition36.ApplyFunction(tla.MakeTLAString("typ")), PUT_REQ(iface)).AsBool() {
					...
					exprRead28, err = iface.Read(req18, []tla.TLAValue{})
					if err != nil {
						return err
					}
					var exprRead29 tla.TLAValue
					exprRead29, err = iface.Read(req18, []tla.TLAValue{})
					if err != nil {
						return err
					}
			...
			if tla.TLA_LessThanOrEqualSymbol(condition37, iface.GetConstant("NUM_REPLICAS")()).AsBool() {
				...
				if tla.TLA_NotEqualsSymbol(condition38, iface.Self()).AsBool() {
					...
					case 0:
						...
						exprRead33, err = iface.Read(req26, []tla.TLAValue{})
						if err != nil {
							return err
						}
		...
		Body: func(iface distsys.ArchetypeInterface) error {
			...
			if tla.TLA_GreaterThanSymbol(tla.TLA_Cardinality(condition41), tla.MakeTLANumber(0)).AsBool() {
				...
				case 0:
					...
					condition51, err = iface.Read(req27, []tla.TLAValue{})
					if err != nil {
						return err
					}
	...
	distsys.MPCalCriticalSection{
		...
		Body: func(iface distsys.ArchetypeInterface) error {
			...
			exprRead41, err = iface.Read(req28, []tla.TLAValue{})
			if err != nil {
				return err
			}
			...
			exprRead44, err = iface.Read(req28, []tla.TLAValue{})
			if err != nil {
				return err
			}
			...
			if iface.GetConstant("DEBUG")().AsBool() {
				...
				toPrint0, err = iface.Read(req28, []tla.TLAValue{})
				if err != nil {
					return err
				}
				tla.MakeTLATuple(tla.MakeTLAString("ServerSendResp"), iface.Self(), toPrint0.ApplyFunction(tla.MakeTLAString("from"))).PCalPrint()
				return iface.Goto("AReplica.replicaLoop")
			} else {
				return iface.Goto("AReplica.replicaLoop")
			}
	...
	distsys.MPCalCriticalSection{
		...
		Body: func(iface distsys.ArchetypeInterface) error {
			...
			if tla.TLA_TRUE.AsBool() {
				if iface.GetConstant("DEBUG")().AsBool() {
					tla.MakeTLATuple(tla.MakeTLAString("ClientLoop"), iface.Self()).PCalPrint()
					// no statements
				} else {
					// no statements
				}
				...
				err = iface.Write(msg, []tla.TLAValue{}, exprRead46)
				if err != nil {
					return err
				}
				var exprRead47 tla.TLAValue
				exprRead47, err = iface.Read(idx16, []tla.TLAValue{})
				if err != nil {
					return err
				}
				err = iface.Write(idx16, []tla.TLAValue{}, tla.TLA_PlusSymbol(exprRead47, tla.MakeTLANumber(1)))
				if err != nil {
					return err
				}
	...
	distsys.MPCalCriticalSection{
		...
		Body: func(iface distsys.ArchetypeInterface) error {
			...
			exprRead48, err = iface.Read(primary3, []tla.TLAValue{})
			if err != nil {
				return err
			}
			err = iface.Write(replica5, []tla.TLAValue{}, exprRead48)
			if err != nil {
				return err
			}
			...
			if tla.TLA_NotEqualsSymbol(condition55, NULL(iface)).AsBool() {
				...
				case 0:
					...
					exprRead49, err = iface.Read(replica5, []tla.TLAValue{})
					if err != nil {
						return err
					}
					var exprRead50 tla.TLAValue
					exprRead50, err = iface.Read(msg0, []tla.TLAValue{})
					if err != nil {
						return err
					}
					var exprRead51 tla.TLAValue
					exprRead51, err = iface.Read(msg0, []tla.TLAValue{})
					if err != nil {
						return err
					}
					var exprRead52 tla.TLAValue
					exprRead52, err = iface.Read(idx18, []tla.TLAValue{})
					if err != nil {
						return err
					}
					err = iface.Write(req31, []tla.TLAValue{}, tla.MakeTLARecord([]tla.TLARecordField{
						{tla.MakeTLAString("from"), iface.Self()},
						{tla.MakeTLAString("to"), exprRead49},
						{tla.MakeTLAString("body"), exprRead50.ApplyFunction(tla.MakeTLAString("body"))},
						{tla.MakeTLAString("srcTyp"), CLIENT_SRC(iface)},
						{tla.MakeTLAString("typ"), exprRead51.ApplyFunction(tla.MakeTLAString("typ"))},
						{tla.MakeTLAString("id"), exprRead52},
					}))
					if err != nil {
						return err
					}
					var exprRead53 tla.TLAValue
					exprRead53, err = iface.Read(req31, []tla.TLAValue{})
					if err != nil {
						return err
					}
					var indexRead7 tla.TLAValue
					indexRead7, err = iface.Read(req31, []tla.TLAValue{})
					if err != nil {
						return err
					}
					err = iface.Write(net6, []tla.TLAValue{tla.MakeTLATuple(indexRead7.ApplyFunction(tla.MakeTLAString("to")), REQ_INDEX(iface))}, exprRead53)
					if err != nil {
						return err
					}
					if iface.GetConstant("DEBUG")().AsBool() {
						var toPrint1 tla.TLAValue
						toPrint1, err = iface.Read(replica5, []tla.TLAValue{})
						if err != nil {
							return err
						}
						tla.MakeTLATuple(tla.MakeTLAString("ClientSendReq"), iface.Self(), toPrint1).PCalPrint()
	...
	distsys.MPCalCriticalSection{
		...
		Body: func(iface distsys.ArchetypeInterface) error {
			...
			if iface.GetConstant("DEBUG")().AsBool() {
				tla.MakeTLATuple(tla.MakeTLAString("ClientRcvRespEither"), iface.Self()).PCalPrint()
				// no statements
			} else {
				// no statements
			}
			...
			case 0:
				...
				exprRead54, err = iface.Read(net7, []tla.TLAValue{tla.MakeTLATuple(iface.Self(), RESP_INDEX(iface))})
				if err != nil {
					return err
				}
				err = iface.Write(resp6, []tla.TLAValue{}, exprRead54)
				if err != nil {
					return err
				}
				if iface.GetConstant("DEBUG")().AsBool() {
					var toPrint2 tla.TLAValue
					toPrint2, err = iface.Read(replica10, []tla.TLAValue{})
					if err != nil {
						return err
					}
					tla.MakeTLATuple(tla.MakeTLAString("ClientRcvResp"), iface.Self(), toPrint2).PCalPrint()
					// no statements
				} else {
					// no statements
				}
				...
				condition59, err = iface.Read(idx19, []tla.TLAValue{})
				if err != nil {
					return err
				}
				if tla.TLA_NotEqualsSymbol(condition58.ApplyFunction(tla.MakeTLAString("id")), condition59).AsBool() {
					return iface.Goto("AClient.rcvResp")
				} else {
					var condition60 tla.TLAValue
					condition60, err = iface.Read(msg2, []tla.TLAValue{})
					if err != nil {
						return err
					}
					if tla.TLA_EqualsSymbol(condition60.ApplyFunction(tla.MakeTLAString("typ")), PUT_REQ(iface)).AsBool() {
						...
						condition63, err = iface.Read(replica10, []tla.TLAValue{})
						if err != nil {
							return err
						}
						...
						condition65, err = iface.Read(resp6, []tla.TLAValue{})
						if err != nil {
							return err
						}
						var condition66 tla.TLAValue
						condition66, err = iface.Read(resp6, []tla.TLAValue{})
						if err != nil {
							return err
						}
						var condition67 tla.TLAValue
						condition67, err = iface.Read(resp6, []tla.TLAValue{})
						if err != nil {
							return err
						}
						var condition68 tla.TLAValue
						condition68, err = iface.Read(idx19, []tla.TLAValue{})
						if err != nil {
							return err
						}
						if !tla.MakeTLABool(tla.MakeTLABool(tla.MakeTLABool(tla.MakeTLABool(tla.MakeTLABool(tla.TLA_EqualsSymbol(condition61.ApplyFunction(tla.MakeTLAString("to")), iface.Self()).AsBool() && tla.TLA_EqualsSymbol(condition62.ApplyFunction(tla.MakeTLAString("from")), condition63).AsBool()).AsBool() && tla.TLA_EqualsSymbol(condition64.ApplyFunction(tla.MakeTLAString("body")), ACK_MSG_BODY(iface)).AsBool()).AsBool() && tla.TLA_EqualsSymbol(condition65.ApplyFunction(tla.MakeTLAString("srcTyp")), PRIMARY_SRC(iface)).AsBool()).AsBool() && tla.TLA_EqualsSymbol(condition66.ApplyFunction(tla.MakeTLAString("typ")), PUT_RESP(iface)).AsBool()).AsBool() && tla.TLA_EqualsSymbol(condition67.ApplyFunction(tla.MakeTLAString("id")), condition68).AsBool()).AsBool() {
						...
						exprRead55, err = iface.Read(resp6, []tla.TLAValue{})
						if err != nil {
							return err
						}
						err = iface.Write(output, []tla.TLAValue{}, exprRead55.ApplyFunction(tla.MakeTLAString("body")).ApplyFunction(tla.MakeTLAString("content")))
						if err != nil {
							return err
						}
						...
						condition69, err = iface.Read(msg2, []tla.TLAValue{})
						if err != nil {
							return err
						}
						if tla.TLA_EqualsSymbol(condition69.ApplyFunction(tla.MakeTLAString("typ")), GET_REQ(iface)).AsBool() {
							var condition70 tla.TLAValue
							condition70, err = iface.Read(resp6, []tla.TLAValue{})
							if err != nil {
								return err
							}
							var condition71 tla.TLAValue
							condition71, err = iface.Read(resp6, []tla.TLAValue{})
							if err != nil {
								return err
							}
							var condition72 tla.TLAValue
							condition72, err = iface.Read(replica10, []tla.TLAValue{})
							if err != nil {
								return err
							}
							var condition73 tla.TLAValue
							condition73, err = iface.Read(resp6, []tla.TLAValue{})
							if err != nil {
								return err
							}
							var condition74 tla.TLAValue
							condition74, err = iface.Read(resp6, []tla.TLAValue{})
							if err != nil {
								return err
							}
							var condition75 tla.TLAValue
							condition75, err = iface.Read(resp6, []tla.TLAValue{})
							if err != nil {
								return err
							}
							var condition76 tla.TLAValue
							condition76, err = iface.Read(idx19, []tla.TLAValue{})
							if err != nil {
								return err
							}
							if !tla.MakeTLABool(tla.MakeTLABool(tla.MakeTLABool(tla.MakeTLABool(tla.TLA_EqualsSymbol(condition70.ApplyFunction(tla.MakeTLAString("to")), iface.Self()).AsBool() && tla.TLA_EqualsSymbol(condition71.ApplyFunction(tla.MakeTLAString("from")), condition72).AsBool()).AsBool() && tla.TLA_EqualsSymbol(condition73.ApplyFunction(tla.MakeTLAString("srcTyp")), PRIMARY_SRC(iface)).AsBool()).AsBool() && tla.TLA_EqualsSymbol(condition74.ApplyFunction(tla.MakeTLAString("typ")), GET_RESP(iface)).AsBool()).AsBool() && tla.TLA_EqualsSymbol(condition75.ApplyFunction(tla.MakeTLAString("id")), condition76).AsBool()).AsBool() {
							...
							exprRead56, err = iface.Read(resp6, []tla.TLAValue{})
							if err != nil {
								return err
							}
							err = iface.Write(output, []tla.TLAValue{}, exprRead56.ApplyFunction(tla.MakeTLAString("body")).ApplyFunction(tla.MakeTLAString("content")))
							if err != nil {
								return err
							}
							return iface.Goto("AClient.clientLoop")
			...
			case 1:
				...
				condition77, err = iface.Read(replica10, []tla.TLAValue{})
				if err != nil {
					return err
				}
				var condition78 tla.TLAValue
				condition78, err = iface.Read(fd8, []tla.TLAValue{condition77})
				if err != nil {
					return err
				}
				var condition79 tla.TLAValue
				condition79, err = iface.Read(netLen1, []tla.TLAValue{tla.MakeTLATuple(iface.Self(), RESP_INDEX(iface))})
				if err != nil {
					return err
				}
				...
				if iface.GetConstant("DEBUG")().AsBool() {
					...
					toPrint3, err = iface.Read(replica10, []tla.TLAValue{})
					if err != nil {
						return err
					}
					tla.MakeTLATuple(tla.MakeTLAString("ClientDetectedFail"), iface.Self(), toPrint3).PCalPrint()
					// no statements
				} else {
					// no statements
				}
